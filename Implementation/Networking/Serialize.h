...
namespace ManaCraft {
	namespace Networking {
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeInt8(byte* data, __int8 num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeUInt8(byte* data, unsigned __int8 num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeInt16(byte* data, __int16 num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeUInt16(byte* data, unsigned __int16 num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeInt32(byte* data, __int32 num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeUInt32(byte* data, unsigned __int32 num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeInt64(byte* data, __int64 num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeUInt64(byte* data, unsigned __int64 num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeFloat(byte* data, float num);
		...
		/// </summary>
		extern NETWORKING_API byte* SerializeDouble(byte* data, double num);
		...
		/// </summary>
		extern NETWORKING_API unsigned __int8 DeserializeUInt8(byte* data);
		...
		/// </summary>
		extern NETWORKING_API unsigned __int16 DeserializeUInt16(byte* data);
		...
		/// </summary>
		extern NETWORKING_API unsigned __int32 DeserializeUInt32(byte* data);
		...
		/// </summary>
		extern NETWORKING_API unsigned __int64 DeserializeUInt64(byte* data);
