...
#pragma region Removes
	...
	{
		for (int i = 0; i < guiContainerKeys.size(); i++)
		{
	...
	{
		for (int i = 0; i < guiElementKeys.size(); i++)
		{
	...
	{
		for (int i = 0; i < textFieldKeys.size(); i++)
		{
	...
	{
		for (int i = 0; i < checkboxKeys.size(); i++)
		{
	...
	{
		for (int i = 0; i < sliderKeys.size(); i++)
		{
